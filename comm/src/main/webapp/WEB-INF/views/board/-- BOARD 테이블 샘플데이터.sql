...
SELECT * FROM BOARD;
SELECT * FROM BOARD WHERE BOARD_NO = 999;
SELECT * FROM BOARD_IMG WHERE BOARD_NO = 1564;
SELECT * FROM BOARD_IMG;

ALTER TABLE BOARD_IMG
RENAME COLUMN IMG_ORGINAL TO IMG_ORIGINAL;
...
INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모1', DEFAULT, DEFAULT, 1, 1541, NULL);
INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모1-자식1', DEFAULT, DEFAULT, 1, 1541, 1);
INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모1-자식2', DEFAULT, DEFAULT, 1, 1541, 1);
INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모1-자식3', DEFAULT, DEFAULT, 1, 1541, 1);

INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모2', DEFAULT, DEFAULT, 1, 1541, NULL);
INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모3', DEFAULT, DEFAULT, 1, 1541, NULL);
INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모4', DEFAULT, DEFAULT, 1, 1541, NULL);

INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모2-자식1', DEFAULT, DEFAULT, 1, 1541, 5);
INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모2-자식2', DEFAULT, DEFAULT, 1, 1541, 5);
INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모2-자식3', DEFAULT, DEFAULT, 1, 1541, 5);


INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모1-자식3-손자1', DEFAULT, DEFAULT, 1, 1541, 4);
INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모1-자식3-손자2', DEFAULT, DEFAULT, 1, 1541, 4);
INSERT INTO REPLY_S VALUES(SEQ_REPLY_NO_S.NEXTVAL, '부모1-자식3-손자3', DEFAULT, DEFAULT, 1, 1541, 4);
...
- CONNECT BY
  ...
  -> PRIOR(이전의) 연산자와 같이 사용하여 현재 행 이전에 상위 또는 하위 타입이 있을 지 규정
...
SELECT LEVEL, R.* FROM
    ...
    FROM REPLY_S
    JOIN MEMBER_S USING(MEMBER_NO)
    WHERE BOARD_NO = 1541) R

-- 계층형 쿼리로 정렬 후 조건을 이용해서 조회할 행을 제어
WHERE REPLY_ST = 'N'

-- PARENT_REPLY_NO의 값이 NULL인 행이 최상위 부모이다.
